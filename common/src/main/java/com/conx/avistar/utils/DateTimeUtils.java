package com.conx.avistar.utils;
...
public class DateTimeUtils {
    ...
    public static final int compare2DateForHour(final Date date1, final Date date2) {
        if (date1 == null || date2 == null) {
            return 0;
        }
        long time1 = date1.getTime();
        ...
        return (int) (long) duration.getStandardHours();
    ...
    public static final Date stringToDate(String str, String pattern) throws Exception {
    ...
    public static String formatTime(final long second) {
        ...
        final long minutes = second / MINUTE_OF_SECONDS % MINUTE_OF_SECONDS;
    ...
    public static String formatTime2(final long second) {
        final StringBuffer result = new StringBuffer();
        final long hours = second / HOUR_OF_SECONDS;
    ...
    public static void main(String args[]) {
        System.out.print(DateTimeUtils.getDate(new Date(),2));
    }
