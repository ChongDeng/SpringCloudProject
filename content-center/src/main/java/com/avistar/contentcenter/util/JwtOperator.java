package com.avistar.contentcenter.util;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将someToken改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1OTQ2MTQzMzAsImV4cCI6MTU5NTgyMzkzMH0.DlpRqklLdvwYSBYVF6HEYgeYwN2n_euwbTS1IQTAFfo";
...
//        // 将encodedHeader改成你生成的token的第一段（以.为边界）
